...
const LeaveConfirmModal = (props) => {
  ...
  return (
    <div className='flex flex-col gap-2'>
      ...
      <p className='w-full bg-shark-950 p-2 rounded-lg text-shark-300 border border-shark-700 line-clamp-1 my-2 -mx-1'>
        {href}
      </p>
      <p className='text-xs text-shark-300'>
        We screen links before they get posted but you can double check!
      </p>
      <div className='w-full flex gap-2 mt-2 justify-end'>
        <button
          ...
          className=' h-8 px-4 py-1 rounded  hover:bg-shark-700 transition'
        >
          Go back
        </button>
        <Link
